...
void can_send_msg(uint32_t id) {
    ...
    case MCB_SENS_FRONT_1_FRAME_ID:
        msgs.sens_front_1.brake_straingauge_voltage_m_v = mcb_sens_front_1_brake_straingauge_voltage_m_v_encode(anal_get_pin_mv(ANAL8));
        msgs.sens_front_1.steering_voltage_m_v = mcb_sens_front_1_steering_voltage_m_v_encode(anal_get_pin_mv(ANAL5));
        msgs.sens_front_1.throttle_0_voltage_m_v = mcb_sens_front_1_throttle_0_voltage_m_v_encode(anal_get_pin_mv(ANAL6));
    ...
    case MCB_SENS_FRONT_2_FRAME_ID:
        ...
        msgs.sens_front_2.pot_fl_voltage_m_v = mcb_sens_front_2_pot_fl_voltage_m_v_encode(anal_get_pin_mv(POT1));
    ...
    case MCB_SENS_FRONT_3_FRAME_ID:
        ...
        msgs.sens_front_3.straingauge_push_fr_voltage_m_v = mcb_sens_front_3_straingauge_push_fr_voltage_m_v_encode(anal_get_pin_mv(ANAL3));
        msgs.sens_front_3.straingauge_tie_fl_voltage_m_v =  mcb_sens_front_3_straingauge_tie_fl_voltage_m_v_encode(anal_get_pin_mv(ANAL1));
    ...
    case MCB_SENS_FRONT_NTC_FRAME_ID:
        ...
        msgs.sens_front_ntc.ntc_2_resistance      = mcb_sens_front_ntc_ntc_2_resistance_encode(NTC_get_res(NTC2));
        msgs.sens_front_ntc.ntc_3_resistance      = mcb_sens_front_ntc_ntc_3_resistance_encode(NTC_get_res(NTC3));
        msgs.sens_front_ntc.ntc_4_resistance      = mcb_sens_front_ntc_ntc_4_resistance_encode(NTC_get_res(NTC4));
        msgs.sens_front_ntc.ntc_spare1_resistance = mcb_sens_front_ntc_ntc_spare1_resistance_encode(NTC_get_res(NTC5));
    ...
    case MCB_SENS_REAR_1_FRAME_ID:
        msgs.sens_rear_1.brake_pressure_rear_voltage_m_v = mcb_sens_rear_1_brake_pressure_rear_voltage_m_v_encode(anal_get_pin_mv(ANAL10));
        msgs.sens_rear_1.pot_rl_voltage_m_v = mcb_sens_rear_1_pot_rl_voltage_m_v_encode(anal_get_pin_mv(POT2));
    ...
    case MCB_SENS_REAR_3_FRAME_ID:
        ...
        msgs.sens_rear_3.straingauge_push_rr_voltage_m_v = mcb_sens_rear_3_straingauge_push_rr_voltage_m_v_encode(anal_get_pin_mv(ANAL4));
        msgs.sens_rear_3.straingauge_tie_rl_voltage_m_v = mcb_sens_rear_3_straingauge_tie_rl_voltage_m_v_encode(anal_get_pin_mv(ANAL3));
    ...
    case MCB_SENS_REAR_NTC_FRAME_ID:
        ...
        msgs.sens_rear_ntc.ntc_2_resistance = mcb_sens_rear_ntc_ntc_2_resistance_encode(NTC_get_res(NTC2));
        msgs.sens_rear_ntc.ntc_3_resistance = mcb_sens_rear_ntc_ntc_3_resistance_encode(NTC_get_res(NTC3));
        msgs.sens_rear_ntc.ntc_4_resistance = mcb_sens_rear_ntc_ntc_4_resistance_encode(NTC_get_res(NTC4));
        msgs.sens_rear_ntc.ntc_5_resistance = mcb_sens_rear_ntc_ntc_5_resistance_encode(NTC_get_res(NTC5));
