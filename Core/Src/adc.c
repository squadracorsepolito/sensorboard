...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = ANAL11_ADC_IN10_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ANAL11_ADC_IN10_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PC3     ------> ADC3_IN13
    */
    GPIO_InitStruct.Pin = REF_5V_ADC_IN12_Pin|REF_24V_ADC_IN13_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(ANAL11_ADC_IN10_GPIO_Port, ANAL11_ADC_IN10_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(GPIOC, POT1_ADC_IN14_Pin|POT2_ADC_IN15_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3     ------> ADC3_IN13
    */
    HAL_GPIO_DeInit(GPIOC, REF_5V_ADC_IN12_Pin|REF_24V_ADC_IN13_Pin);
