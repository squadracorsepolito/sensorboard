...
#define ANAL11_ADC1_IN10_Pin GPIO_PIN_0
#define ANAL11_ADC1_IN10_GPIO_Port GPIOC
#define ADC1283IPT_DIN_SPI2_MOSI_Pin GPIO_PIN_1
#define ADC1283IPT_DIN_SPI2_MOSI_GPIO_Port GPIOC
#define ANAL1_ADC1_IN0_Pin GPIO_PIN_0
#define ANAL1_ADC1_IN0_GPIO_Port GPIOA
#define ANAL2_ADC1_IN1_Pin GPIO_PIN_1
#define ANAL2_ADC1_IN1_GPIO_Port GPIOA
#define ANAL3_ADC1_IN2_Pin GPIO_PIN_2
#define ANAL3_ADC1_IN2_GPIO_Port GPIOA
#define ANAL4_ADC1_IN3_Pin GPIO_PIN_3
#define ANAL4_ADC1_IN3_GPIO_Port GPIOA
#define ANAL5_ADC1_IN4_Pin GPIO_PIN_4
#define ANAL5_ADC1_IN4_GPIO_Port GPIOA
#define ANAL6_ADC1_IN5_Pin GPIO_PIN_5
#define ANAL6_ADC1_IN5_GPIO_Port GPIOA
#define ANAL7_ADC1_IN6_Pin GPIO_PIN_6
#define ANAL7_ADC1_IN6_GPIO_Port GPIOA
#define ANAL8_ADC1_IN7_Pin GPIO_PIN_7
#define ANAL8_ADC1_IN7_GPIO_Port GPIOA
#define POT1_ADC2_IN14_Pin GPIO_PIN_4
#define POT1_ADC2_IN14_GPIO_Port GPIOC
#define POT2_ADC2_IN15_Pin GPIO_PIN_5
#define POT2_ADC2_IN15_GPIO_Port GPIOC
#define ANAL9_ADC1_IN8_Pin GPIO_PIN_0
#define ANAL9_ADC1_IN8_GPIO_Port GPIOB
#define ANAL10_ADC1_IN9_Pin GPIO_PIN_1
#define ANAL10_ADC1_IN9_GPIO_Port GPIOB
...
#define LED_STAT3_GPIO_OUT_Pin GPIO_PIN_15
#define LED_STAT3_GPIO_OUT_GPIO_Port GPIOB
#define LED_STAT2_GPIO_OUT_Pin GPIO_PIN_6
#define LED_STAT2_GPIO_OUT_GPIO_Port GPIOC
#define LED_STAT1_GPIO_OUT_Pin GPIO_PIN_7
#define LED_STAT1_GPIO_OUT_GPIO_Port GPIOC
#define LED_WARN_GPIO_OUT_Pin GPIO_PIN_8
#define LED_WARN_GPIO_OUT_GPIO_Port GPIOC
#define LED_ERR_GPIO_OUT_Pin GPIO_PIN_9
#define LED_ERR_GPIO_OUT_GPIO_Port GPIOC
